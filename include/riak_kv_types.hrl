...
-define(V3_TOP_LEVEL_TYPES, []).
-define(V4_TOP_LEVEL_TYPES, [?GSET_TYPE]).
-define(TOP_LEVEL_TYPES,
    ?V1_TOP_LEVEL_TYPES ++ ?V2_TOP_LEVEL_TYPES 
...
-define(MOD_MAP, [{map, ?MAP_TYPE}, {set, ?SET_TYPE},
                  {counter, ?COUNTER_TYPE}, {gset, ?GSET_TYPE}]).
...
-define(E2_DATATYPE_VERSIONS, [{?MAP_TYPE, 2},
                               {?SET_TYPE, 2},
                               {?COUNTER_TYPE, 2}]).
-define(E3_DATATYPE_VERSIONS, ?E2_DATATYPE_VERSIONS).
-define(E4_DATATYPE_VERSIONS, ?E2_DATATYPE_VERSIONS ++ [{?GSET_TYPE, 2}]).
